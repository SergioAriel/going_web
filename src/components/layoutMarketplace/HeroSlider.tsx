        ...
        <div className=" flex items-center justify-center">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/marketplace/products" className="btn-primary">
                Explore Products
              </Link>
              <Link href="/marketplace/categories" className="btn-secondary">
                Browse Categories
              </Link>
            </div>
          </div>
    ...
    <div className="relative w-full h-[600px] overflow-hidden bg-gray-900">
      ...
      {slides.map((slide, index) => (
        slide.html ?
          ...
          <div
            key={slide.id}
            className={`absolute inset-0 transition-all ease-in-out duration-1000 ${index
              ? 'opacity-100 scale-100'
              : 'opacity-0 scale-105'
              }`}
          >
            ...
            {/* Slide content */}
            <div
              className={`absolute inset-0 z-20 flex flex-col items-center justify-center text-white text-center px-4 transition-all duration-600 ${index === currentSlide
