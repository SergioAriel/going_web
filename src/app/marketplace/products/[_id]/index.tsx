      ...
      <div className="container mx-auto px-4">
        ...
        <nav className="mb-8">
          <ol className="flex text-sm text-gray-600 dark:text-gray-400">
            <li className="mr-2">
              <Link href="/marketplace" className="hover:text-primary dark:hover:text-primary">Home</Link>
              <span className="mx-2">/</span>
            </li>
            <li className="mr-2">
              <Link href="/marketplace/products" className="hover:text-primary dark:hover:text-primary">Products</Link>
              <span className="mx-2">/</span>
            </li>
            <li className="mr-2">
